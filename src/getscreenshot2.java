 ...
 * @author Manish
 */
public class getscreenshot2 extends javax.swing.JFrame {

    /**
     * Creates new form getscreenshot2
     */
...
//ImageIO is an API which is used to convert BufferedImage to a png/jpg image     
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(getscreenshot2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new getscreenshot2().setVisible(true);
            }
        });
    }
